...
#endif
// for Nuvoton Bulk USB driver interface
const GUID GUID_CLASS_I82930_BULK = { 0x873FDF, 0x61A8, 0x11D1, {0xAA, 0x5E, 0x0, 0xC0, 0x4F, 0xB1, 0x72, 0x8B} };
// for Nuvoton WinUSB driver interface
const GUID GUID_OSR_DEVICE_INTERFACE = { 0x803557FA, 0x2AE7, 0x4DF3, {0xB4, 0x13, 0xC6, 0x07, 0x5A, 0x41, 0xDD, 0x99} };
